    ...
    return initialData && (
        <form onSubmit={handleSubmit(onSubmit)} className="container mt-4" style={{ maxWidth: "600px" }}>
            ...
            <div className="mb-3">
                ...
                <input type="text" id="alternate_names" className="form-control" {...register("alternate_names")} defaultValue={initialData?.alternate_names ? initialData?.alternate_names?.join(', ') : ""} />
            </div>
            {/* Species */}
            <div className="mb-3">
